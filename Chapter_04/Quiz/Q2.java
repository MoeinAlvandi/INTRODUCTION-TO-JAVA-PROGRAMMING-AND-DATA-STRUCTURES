...
public class Q2 {
	 ...
	 * two
	 * points on the earth in degrees and displays its great circle distance. The
	 * average
	 ...
	 * and west. Use negative to indicate south and east degrees. Here is a sample
	 * run:
	 */
	public static void main(String[] args) {
		...
		double result=erthRadios*Math.acos((Math.sin(Math.toRadians(x1))* Math.sin(Math.toRadians(x2)))+
