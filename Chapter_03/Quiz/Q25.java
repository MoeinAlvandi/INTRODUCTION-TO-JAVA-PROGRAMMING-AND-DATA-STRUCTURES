...
public class Q25 {
	/*
	 * 3.25 (Geometry: intersecting point) Two points on line 1 are given as (x1,
	 * y1) and
	 ...
	 * (see Figure 3.8c). Write a program that prompts the user to enter four points and displays the intersecting point. 
